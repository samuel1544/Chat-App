            ...
            <div className={Styles.board}>
                ...
                <div className={Styles.right}>
                    <div className={Styles.sign_in}>
                        ...
                        <div>
                            <button className={Styles.sign}><a href="#">SIGN IN</a></button><br/>
                        </div>
                    ...
                    <div className={Styles.sign_up}>
                        <div className={Styles.wel}>
                            ...
                            <p className={Styles.mes}>Register your account</p>
                        </div>
                        <form className={Styles.forms}>
                            <div>
                                <label for="">Username</label><br/>
                                <input type="text" name="username" id="" placeholder="Enter your username" className={Styles.write} required onChange={(e) =>{Setusername(e.target.value)}}/>
                            </div>
                            <div>
                                <label for="">Email</label><br/>
                            <input type="email" placeholder="Example@gmail.com" className={Styles.write} name="email" required onChange={(e) =>{Setemail(e.target.value)}}/>
                            </div>
                            <div>
                                <label for="">Password</label><br/>
                            <input type="password" placeholder="Enter your password" className={Styles.write} name="password" required onChange={(e) =>{Setpassword(e.target.value)}}/>
                            </div>
                            <div>
                         ...
                         <div className={Styles.create}>
                            <div>
                                <p className={Styles.mes}>create account with</p>
                            </div>
                            <div>
                                <button>
